...
import {ImmuneDbCloneCountParser, ImmuneDBFunctionalityCountStatsParser, ImmuneDBGeneTopCountStatsParser, ImmuneDBGeneUsageStatsParser} from './immuneDbParser.js';
...
class ImmuneDbFunctionalityCountStatsResult extends Result {
  #_logger;
  ...
  constructor() {
    ...
    //this.#_defaultProperties = new Properties().setTitle("Fraction of Top n clones").setYLabel("Fraction (copies in subject/whole repertoire)").setStackingType("normal");
    this.properties.setTitle('Fraction of Top n clones').setStackingType('normal');

    this.setParser(new ImmuneDBFunctionalityCountStatsParser());
  }
  ...
  update(properties) {
    ...
    if (this.properties.dataDrilldown == properties.dataDrilldown) return this;
    this.properties.setDataDrilldown(properties.dataDrilldown);
    return this.setParser(new ImmuneDBFunctionalityCountStatsParser());
  }
}

class ImmuneDBGeneUsageStatsResult extends Result {
  #_logger;
  ...
  constructor() {
    super();
    this.#_logger = new Logger('ImmuneDBGeneUsageStatsResult');
    this.#_logger.debug('Constructor.');

    this.#_drilldownSeries = {series: []};
    this.#_multipleSeries = false;

    this.properties.setTitle('Gene Usage');

    this.setParser(new ImmuneDBGeneUsageStatsParser());
  }
  ...
  update(properties) {
    ...
    if (this.properties.dataDrilldown == properties.dataDrilldown) return this;
    this.properties.setDataDrilldown(properties.dataDrilldown);
    return this.setParser(new ImmuneDBGeneUsageStatsParser());
  }
}
...
export {ImmuneDbCloneCountResult, ImmuneDbFunctionalityCountStatsResult, ImmuneDbTopCountStatsResult, ImmuneDBGeneUsageStatsResult};
