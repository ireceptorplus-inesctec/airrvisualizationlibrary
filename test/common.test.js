...
let variableNamesSubgroup = ["v_subgroup_unique", "d_subgroup_unique", "j_subgroup_unique", "c_subgroup_unique", 
		"v_subgroup_unique_productive", "d_subgroup_unique_productive", "j_subgroup_unique_productive", "c_subgroup_unique_productive", 
		"v_subgroup_exists", "d_subgroup_exists", "j_subgroup_exists", "c_subgroup_exists",	
		"v_subgroup_exists_productive", "d_subgroup_exists_productive", "j_subgroup_exists_productive", "c_subgroup_exists_productive"
	];
let variableNamesGene = ["v_gene_unique", "d_gene_unique", "j_gene_unique", "c_gene_unique",
		"v_gene_unique_productive", "d_gene_unique_productive", "j_gene_unique_productive", "c_gene_unique_productive", 
		"v_gene_exists", "d_gene_exists", "j_gene_exists", "c_gene_exists", 
		"v_gene_exists_productive", "d_gene_exists_productive", "j_gene_exists_productive", "c_gene_exists_productive"
	];
let variableNamesCall = ["v_call_unique", "d_call_unique", "j_call_unique", "c_call_unique", 
		"v_call_unique_productive", "d_call_unique_productive",	"j_call_unique_productive", "c_call_unique_productive", 
		"v_call_exists", "d_call_exists", "j_call_exists", "c_call_exists", 
		"v_call_exists_productive", "d_call_exists_productive", "j_call_exists_productive", "c_call_exists_productive"
	];
let variableNamesNotProductive = ["v_call_unique", "d_call_unique", "j_call_unique", "c_call_unique", "v_call_exists", "d_call_exists", "j_call_exists", "c_call_exists", 
		"v_gene_unique", "d_gene_unique", "j_gene_unique", "c_gene_unique", "v_gene_exists", "d_gene_exists", "j_gene_exists", "c_gene_exists", 
		"v_subgroup_unique", "d_subgroup_unique", "j_subgroup_unique", "c_subgroup_unique", "v_subgroup_exists", "d_subgroup_exists", "j_subgroup_exists", "c_subgroup_exists",
		"top_clones", "junction_length", "junction_aa_length", "rearrangement_count", "duplicate_count", 
	];
let variableNamesProductive = ["v_call_unique_productive", "d_call_unique_productive", "j_call_unique_productive", "c_call_unique_productive", "v_call_exists_productive", "d_call_exists_productive", "j_call_exists_productive", "c_call_exists_productive", 
		"v_gene_unique_productive", "d_gene_unique_productive", "j_gene_unique_productive", "c_gene_unique_productive", "v_gene_exists_productive", "d_gene_exists_productive", "j_gene_exists_productive", "c_gene_exists_productive",
		"v_subgroup_unique_productive", "d_subgroup_unique_productive",	"j_subgroup_unique_productive", "c_subgroup_unique_productive", "v_subgroup_exists_productive", "d_subgroup_exists_productive", "j_subgroup_exists_productive", "c_subgroup_exists_productive", 
		"junction_length_productive", "junction_aa_length_productive", "rearrangement_count_productive", "duplicate_count_productive"
	];
let variableNamesExists = ["v_call_exists", "d_call_exists", "j_call_exists", "c_call_exists", "v_call_exists_productive", "d_call_exists_productive", "j_call_exists_productive", "c_call_exists_productive", 
		"v_gene_exists", "d_gene_exists", "j_gene_exists", "c_gene_exists", "v_gene_exists_productive", "d_gene_exists_productive", "j_gene_exists_productive", "c_gene_exists_productive",
		"v_subgroup_exists", "d_subgroup_exists", "j_subgroup_exists", "c_subgroup_exists",	"v_subgroup_exists_productive", "d_subgroup_exists_productive", "j_subgroup_exists_productive", "c_subgroup_exists_productive"
	];
let variableNamesUnique = ["v_call_unique", "d_call_unique", "j_call_unique", "c_call_unique", "v_call_unique_productive", "d_call_unique_productive", "j_call_unique_productive", "c_call_unique_productive", 
		"v_gene_unique", "d_gene_unique", "j_gene_unique", "c_gene_unique",	"v_gene_unique_productive", "d_gene_unique_productive", "j_gene_unique_productive", "c_gene_unique_productive",
		"v_subgroup_unique", "d_subgroup_unique", "j_subgroup_unique", "c_subgroup_unique", "v_subgroup_unique_productive", "d_subgroup_unique_productive", "j_subgroup_unique_productive", "c_subgroup_unique_productive"
	];
