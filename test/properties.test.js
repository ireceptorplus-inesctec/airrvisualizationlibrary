...
describe('Set Properties', function () {
  ...
  it('should allow to set properties: data, dataType, dataDrilldown', function () {
    let obj = {
      setAsData: propertyData,
      setAsDataType: propertyDatatype,
      setAsDataDrilldown: propertyDataDrilldown,
      typeofData: 'object',
      typeofDataType: 'string',
      typeofDataDrilldown: 'boolean',
      defaultData: undefined,
      defaultDataType: undefined,
      defaultDataDrilldown: Properties.DEFAULT_DATA_DRILLDOWN,
    };
    // Set/get as method
